...
def encrypt_image(input_path, output_path, key, filename):
    ...
    # Rename the file with the provided filename
...
def encrypt():
    ...
    if not filename:
        info_label.config(text="Please enter a filename.", fg="red")
        return
    encrypted_image_path = "encrypted_image.png"
    encrypt_image(input_path, encrypted_image_path, key, filename)
...
def decrypt():
    ...
    decrypt_image(input_path, decrypted_image_path, key, filename)
